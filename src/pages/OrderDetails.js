...
const OrderDetails = () => {
    ...
    const updateOrderStatus = async () => {
        ...
        try {
            ...
            if (responseData.success) {
                ...
                toast.error("Failed to update order status: " + responseData.message);
            }
        } catch (error) {
    ...
    return (
        <section className="container mx-auto p-4">
            ...
            <button
                className="border-m text-center text-blue-600 hover:bg-gray-100 hover:text-blue-800 transition-all"
                    ...
                    <tbody>
                        {order.productDetails.map((product, index) => (
                            <tr key={product._id} className="border-b text-center">
                                ...
                                <td className="py-2 px-14 border flex items-center gap-2">
                                    <img
